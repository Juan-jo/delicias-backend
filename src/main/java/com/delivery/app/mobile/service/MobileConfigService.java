...
import com.delivery.app.mobile.dtos.MobileConfigDTO;
import com.delivery.app.mobile.model.MobileConfig;
import com.delivery.app.mobile.repository.MobileConfigRepository;
...
public class MobileConfigService {
    ...
    public Map<String, Object> loadCharges(Integer restaurantId, Double latitude,  Double longitude) {
