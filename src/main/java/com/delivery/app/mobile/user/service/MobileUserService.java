...
public class MobileUserService {
    ...
    public Set<MobileUserNearbyGeocodingDTO> searchNearby(double lat, double lng) throws IOException, InterruptedException, ApiException {
        ...
        if(deliciasAppProperties.getProduction()) {
            return Arrays.stream(googleMapsService.reverseGeocode(lat, lng)).map(
                    geoItem -> {
                        ...
                        return MobileUserNearbyGeocodingDTO.builder()
                                .street(ruta)
                                .address(address)
                                .latitude(lat)
                                .longitude(lng)
            ...
            // mock develop
            return Set.of(
                    MobileUserNearbyGeocodingDTO.builder()
